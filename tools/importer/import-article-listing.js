...
const PAGE_TEMPLATE = {
  ...
  description: 'Index layout: hero header followed by a grid of teaser cards linking to detail pages',
  ...
  blocks: [
    ...
    { name: 'section-articles', instances: ['#articles'], section: 'light' },
    { name: 'cards-article', instances: ['#articles'] },
