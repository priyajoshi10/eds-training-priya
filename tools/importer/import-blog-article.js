...
const parsers = { 'hero-article': heroArticleParser };
const transformers = [cleanupTransformer];

const PAGE_TEMPLATE = {
  name: 'blog-article',
  description: 'Article detail layout: hero header followed by long-form body content sections',
  urls: ['https://wknd-trendsetters.site/blog/ace-pro-court-polo'],
  blocks: [
